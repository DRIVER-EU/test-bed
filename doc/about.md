...
<table style="border: 2px solid black">
  ...
  <tr><td style="font-weight: bold; color: white; background: #00497E">Document Title:</td><td>Test-bed Specification</td></tr>
  ...
  <tr><td style="font-weight: bold; color: white; background: #00497E">File Name:</td><td>test-bed-specification.pdf</td></tr>
</table>
